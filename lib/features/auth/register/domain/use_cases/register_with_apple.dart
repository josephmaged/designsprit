...
class RegisterWithAppleUsecase extends BaseUseCase<RegisterResponse, NoParameters> {
  final BaseRegisterRepo baseRegisterRepo;

  RegisterWithAppleUsecase(this.baseRegisterRepo);

  @override
  Future<Either<Failure, RegisterResponse>> call(NoParameters noParameters) async {
    return await baseRegisterRepo.registerWithApple();
  }
}
